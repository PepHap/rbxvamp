...
local function createInstance(className)
    if CompanionUISystem.useRobloxObjects and typeof ~= nil and Instance and type(Instance.new) == "function" then
...
function CompanionUISystem:start(compSys, parentGui)
    ...
    if not self.window then
        local closeBtn
        self.window, closeBtn = GuiUtil.createWindow("CompanionWindow")
