...
local NetworkSystem = require(script.Parent.Parent:WaitForChild("NetworkServer"))
local AutoBattleSystem = require(script.Parent.Parent:WaitForChild("AutoBattleSystem"))
local InventoryUISystem = require(script.Parent.Parent:WaitForChild("InventoryUISystem"))
...
local MenuUISystem = require(script.Parent.Parent:WaitForChild("MenuUISystem"))
...
local GachaUISystem = require(script.Parent.Parent:WaitForChild("GachaUISystem"))
local RewardGaugeUISystem = require(script.Parent.Parent:WaitForChild("RewardGaugeUISystem"))
local StatUpgradeUISystem = require(script.Parent.Parent:WaitForChild("StatUpgradeUISystem"))
local StatUpgradeSystem = require(script.Parent.Parent:WaitForChild("StatUpgradeSystem"))
local QuestUISystem = require(script.Parent.Parent:WaitForChild("QuestUISystem"))
local AchievementUISystem = require(script.Parent.Parent:WaitForChild("AchievementUISystem"))
local CrystalExchangeUISystem = require(script.Parent.Parent:WaitForChild("CrystalExchangeUISystem"))
local ProgressMapUISystem = require(script.Parent.Parent:WaitForChild("ProgressMapUISystem"))
local LevelUISystem = require(script.Parent.Parent:WaitForChild("LevelUISystem"))
local AdminConsoleSystem = require(script.Parent:FindFirstChild("AdminConsoleSystem"))
local LobbySystem = require(script.Parent.Parent:WaitForChild("LobbySystem"))
local LobbyUISystem = require(script.Parent.Parent:WaitForChild("LobbyUISystem"))
local PartyUISystem = require(script.Parent.Parent:WaitForChild("PartyUISystem"))
local NetworkSystem = require(script.Parent.Parent:WaitForChild("NetworkServer"))
